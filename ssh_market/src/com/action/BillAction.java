...
@Results({
	@Result(name="list",location="/jsps/pages/bill-list.jsp"),
	@Result(name="add",location="/jsps/pages/bill-add.jsp"),
	@Result(name="relist",type="redirect",location="billList.action"),
})
