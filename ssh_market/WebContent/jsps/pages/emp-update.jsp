...
<body>
	...
	<form action="empUpdate.action" method="post" onsubmit="return checkForm()">
	...
	职位：<select name="emp.type" style="width: 155px">
				<option value="1" <s:if test="request.emp.type==1">selected="selected"</s:if>>经理</option>
				<option value="2" <s:if test="request.emp.type==2">selected="selected"</s:if>>库管</option>
				<option value="3" <s:if test="request.emp.type==3">selected="selected"</s:if>>员工</option>
			</select><br>
